...
foreach($docfind as $obj)
 ...
 <center><form action="update.php" method="POST">
	  ...
	  <th>Card number:<td>
          <?php echo "<h2>".$obj['cardno']."</h2>";?><tr>
	
          <th>Firstname:<td>
          <input type="text"  name="firstname" value="<?php echo $obj['firstname'];?>" style="padding-left: 20px"><tr>
	
	  <th>Lastname:<td>
          <input type="text"  name="lastname" value="<?php echo $obj['lastname'];?>" style="padding-left: 20px"><tr>
          
          <th>Email:<td>
          <input type="email"  name="email" value="<?php echo $obj['email'];?>" style="padding-left: 20px"><tr>
          
	  <th>Phone number:<td>
          <input type="text"  name="phoneno" value="<?php echo $obj['phoneno'];?>" style="padding-left: 20px"><tr>
           
          <th>Date of birth:<td>
          <input type="date"  name="dob" value="<?php echo $obj['dob'];?>" style="padding-left: 20px"><tr><br>

          <th>Address:<tr>

          <th>&nbsp;House No:<td>
          <input type="text" name="houseno" value="<?php echo $obj['address']['houseno'];?>" style="padding-left: 20px"><tr>

          <th>&nbsp;Street:<td>
          <input type="text" name="street" value="<?php echo $obj['address']['street'];?>" style="padding-left: 20px"><tr>


          <th>&nbsp;City:<td>
          <input type="text" name="city" value="<?php echo $obj['address']['city'];?>" style="padding-left: 20px"><tr>

          <th>&nbsp;State:<td>
          <input type="text" name="state" value="<?php echo $obj['address']['state'];?>" style="padding-left: 20px"><tr>


          <th>&nbsp;Country:<td>
          <input type="text" name="country" value="<?php echo $obj['address']['country'];?>" style="padding-left: 20px"><tr>
             
      <td><td><br><button type="submit" name="submit" value="update">UPDATE</button>
        <button type="submit" name="submit" value="delete">DELETEACCOUNT</button>
	</table>
<?php }} ?>
      </form></center>
